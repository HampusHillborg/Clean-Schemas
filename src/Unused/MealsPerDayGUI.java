...
public class MealsPerDayGUI extends JFrame implements ActionListener {
    ...
    // private String[] breakfastFoods = {"Eggs", "Oatmeal", "Yogurt", "Toast",
    // "Fruit"};
    // private String[] lunchFoods = {"Sandwich", "Salad", "Soup", "Leftovers",
    // "Wrap"};
    // private String[] dinnerFoods = {"Chicken", "Beef", "Fish", "Vegetables",
    // "Pasta"};
    private String[] breakfastFoods = { "Eggs (protein: 6g, fat: 5g, carbs: 0.6g, calories: 78)",
            "Oatmeal (protein: 6g, fat: 2g, carbs: 27g, calories: 150)",
            "Yogurt (protein: 12g, fat: 0.5g, carbs: 17g, calories: 110)",
            "Toast (protein: 3g, fat: 1g, carbs: 12g, calories: 70)",
            "Fruit (protein: 1g, fat: 0g, carbs: 15g, calories: 60)" };
    private String[] lunchFoods = { "Sandwich (protein: 20g, fat: 10g, carbs: 30g, calories: 350)",
            "Salad (protein: 10g, fat: 5g, carbs: 20g, calories: 150)",
            "Soup (protein: 8g, fat: 5g, carbs: 10g, calories: 120)",
            "Leftovers (protein: varies, fat: varies, carbs: varies, calories: varies)",
            "Wrap (protein: 25g, fat: 10g, carbs: 30g, calories: 400)" };
    private String[] dinnerFoods = { "Chicken (protein: 30g, fat: 10g, carbs: 0g, calories: 250)",
            "Beef (protein: 25g, fat: 20g, carbs: 0g, calories: 300)",
            "Fish (protein: 20g, fat: 10g, carbs: 0g, calories: 200)",
            "Vegetables (protein: 5g, fat: 0.5g, carbs: 15g, calories: 75)",
            "Pasta (protein: 8g, fat: 3g, carbs: 30g, calories: 200)" };
